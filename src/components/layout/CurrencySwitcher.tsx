...
import { currencies, currencyLabels, currencySymbols } from '@/lib/money/currency';
      ...
      {currencies.map((item) => {
        ...
        return (
          ...
          >
            ...
            <span className="min-w-0 truncate text-xs text-gray-500">{currencyLabels[item]}</span>
          </button>
        );
      })}
    </IconDropdown>
