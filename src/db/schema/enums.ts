...
export const mediaUploadStatusEnum = pgEnum('media_upload_status', ['PENDING', 'READY', 'FAILED']);
...
export const cartStatusEnum = pgEnum('cart_status', ['ACTIVE', 'MERGED', 'CONVERTED', 'ABANDONED']);

export const promotionKindEnum = pgEnum('promotion_kind', ['COUPON', 'AUTOMATIC']);
...
export const productModifierKindEnum = pgEnum('product_modifier_kind', ['ADDITION', 'EXCEPTION']);
...
export const groupOrderParticipantRoleEnum = pgEnum('group_order_participant_role', [
  'ORGANIZER',
  'PARTICIPANT',
]);

export const groupOrderParticipantStatusEnum = pgEnum('group_order_participant_status', [
  'ACTIVE',
  'REMOVED',
  'LEFT',
]);
...
export const groupOrderParticipantPaymentStatusEnum = pgEnum(
  ...
  ['NOT_REQUIRED', 'PENDING', 'PAID', 'FAILED', 'REFUNDED', 'MARKED_RECEIVED'],
);
