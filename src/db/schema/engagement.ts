...
import { contactMessageStatusEnum, reviewModerationStatusEnum } from '@/db/schema/enums';
...
export const contactMessages = pgTable(
  ...
  (table) => [index('contact_messages_status_created_idx').on(table.status, table.createdAt)],
);
