...
export const promotions = pgTable(
  ...
  (table) => [
    ...
    index('promotions_active_dates_idx').on(table.isActive, table.startsAt, table.endsAt),
...
export const promotionUsers = pgTable(
  ...
  (table) => [uniqueIndex('promotion_users_uidx').on(table.promotionId, table.userId)],
);
