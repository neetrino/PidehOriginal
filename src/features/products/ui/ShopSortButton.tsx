  ...
  return (
    <div className="relative w-max max-w-full shrink-0">
      <SelectDropdown
        ...
        tone="brand"
        trigger={
          <span className="inline-flex h-[53px] min-h-[44px] min-w-0 items-center justify-center gap-px rounded-[30px] bg-[#ff6900] px-3 py-1.5 text-sm font-bold text-white transition duration-200 hover:scale-[1.04] hover:brightness-105">
            <Image
