...
import { buildAnalyticsCsv, guardCsvCell } from '@/features/analytics/domain/csv';
...
describe('buildAnalyticsCsv', () => {
  ...
  it('builds CSV with guarded date cells', () => {
    ...
    expect(csv.startsWith('date,orderCount,revenueAmount,averageOrderValue')).toBe(true);
  });
});
