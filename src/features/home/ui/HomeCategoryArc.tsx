 ...
 */
export function HomeCategoryArc({ className = '', style }: HomeCategoryArcProps) {
  return (
    <div aria-hidden="true" className={`pointer-events-none size-full ${className}`} style={style}>
      <svg
