    ...
    <article className="flex h-[242px] w-[min(434px,85vw)] shrink-0 flex-col overflow-hidden rounded-[24px] bg-white p-6 shadow-[0px_10px_24px_0px_rgba(31,20,8,0.09)]">
      <div className="flex items-center gap-[14px]">
        ...
        <div className="flex flex-col gap-[3px]">
          <p className="text-base leading-[1.25] font-bold text-[#1e1e1e]">{review.name}</p>
          <p className="text-[13px] leading-[1.25] font-bold text-[#ff6b00]" aria-hidden="true">
            ★★★★★
          </p>
        </div>
      </div>
      ...
      <p className="line-clamp-3 text-[15px] leading-[1.25] text-[#1e1e1e]">{review.text}</p>
