...
export const ADMIN_TABLE_OUTER_CLIP = 'w-full min-w-0 overflow-hidden rounded-t-[18px]';
...
export const ADMIN_TABLE = 'w-full min-w-full table-auto border-collapse text-left text-sm';

export const ADMIN_TABLE_THEAD = 'border-b-2 border-[#1e1e1e]/10 bg-[#fff8e7]';

export const ADMIN_TABLE_TH_CHECK = 'w-px whitespace-nowrap px-2 py-2.5 text-center align-middle';
...
export const ADMIN_TABLE_TBODY = 'divide-y divide-[#1e1e1e]/10 bg-white [&_td]:align-middle';

export const ADMIN_TABLE_ROW = 'hover:bg-[#ffd54a]/25';

export const ADMIN_TABLE_TD_CHECK = 'w-px whitespace-nowrap px-3 py-2.5 align-middle';
...
export const ADMIN_TABLE_FOOTER = 'border-t-2 border-[#1e1e1e]/10 px-4 py-3 sm:px-5';
