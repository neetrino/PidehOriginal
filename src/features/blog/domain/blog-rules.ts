...
export type BlogRuleError =
  'TITLE_REQUIRED' | 'SLUG_REQUIRED' | 'CONTENT_REQUIRED' | 'INVALID_SLUG';
...
export function validateBlogLocaleCopy(copy: BlogLocaleCopy): BlogRuleError | null {
  if (!copy.title.trim()) {
...
export function validateBlogTranslations(translations: BlogTranslations): BlogRuleError | null {
