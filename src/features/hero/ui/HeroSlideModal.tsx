...
export function HeroSlideModal({ locale, open, onClose, slide = null, copy }: HeroSlideModalProps) {
...
function HeroSlideDrawerForm({ locale, onClose, slide, copy }: HeroSlideDrawerFormProps) {
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-5">
          ...
          <div>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-3">
              ...
              >
                {imagePreview ? copy.hero.drawer.changeImage : copy.hero.drawer.uploadImageButton}
              </button>
              <input
                ref={fileInputRef}
                type="file"
