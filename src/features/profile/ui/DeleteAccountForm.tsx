  ...
  return (
    <div className="profile-sheet-keep-frame space-y-6">
      ...
      <div className={`${PROFILE_PANEL} border-red-200`}>
        ...
        <form action={formAction} className="mx-auto max-w-xl space-y-6 lg:mx-0 lg:max-w-2xl">
          ...
          <label className="flex cursor-pointer items-start gap-3">
            ...
            />
            <span className="text-sm leading-snug text-[#1e1e1e]">{labels.acknowledge}</span>
          </label>
