...
export const PROFILE_LABEL = 'flex flex-col gap-1.5 text-sm font-bold text-[#1e1e1e]';

export const PROFILE_PRIMARY_BTN =
  '!rounded-full !bg-[#ff6b00] font-bold text-white hover:!bg-[#e85f00] focus:!ring-[#ff6b00]';

export const PROFILE_OUTLINE_BTN =
  '!rounded-full border-[#ff6b00]/30 bg-white text-[#1e1e1e] hover:!bg-[#fff8e7] focus:!ring-[#ff6b00]';
