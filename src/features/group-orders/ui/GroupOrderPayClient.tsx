    ...
    return (
      <div className="mx-auto max-w-md px-4 py-10">
        <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-6 text-center">
          <h1 className="text-xl font-bold text-emerald-950">{labels.payAlreadyPaidTitle}</h1>
          <p className="mt-2 text-sm text-emerald-800">{labels.payAlreadyPaidHint}</p>
          <AppLink
            href={backHref}
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10">
      <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-lg">
        ...
        <p className="mt-5 text-3xl font-bold tabular-nums text-gray-900">{amountFormatted}</p>
        <p className="mt-1 text-xs text-gray-500">{labels.payAmountHint}</p>

        <fieldset className="mt-6 space-y-3">
          <legend className="text-sm font-medium text-gray-900">{labels.paySelectProvider}</legend>
          {(
            [
              {
                id: 'arca' as const,
