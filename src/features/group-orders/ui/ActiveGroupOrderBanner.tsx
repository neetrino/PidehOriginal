...
export function ActiveGroupOrderBanner({
  ...
  return (
    <div className="border-b border-amber-200 bg-amber-50">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-2 px-4 py-2 text-sm text-amber-950">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            disabled={pending}
            className="text-amber-800/80 hover:text-amber-950"
            onClick={() => {
