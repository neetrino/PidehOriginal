...
General structure of the request and the response 1. Function of getting unique payment ID: InitPayment 2. Function of getting payment information: GetPaymentDetails 3. Payment confirmation function: ConfirmPayment 4. Payment cancellation function: CancelPayment 5. Function of partial refund of the sum: RefundPayment 6. Function of getting information about all payments: GetTransactionList 7. Function of getting information about problem transactions: GetProblemTransactions
Binding transactions 8. Function of making binding payment transactions: MakeBindingPayment 9. Function of receiving information about bindings: GetBindings 10. Bindings deactivation function: DeactivateBindings 11. Bindings activation function: ActivateBindings
